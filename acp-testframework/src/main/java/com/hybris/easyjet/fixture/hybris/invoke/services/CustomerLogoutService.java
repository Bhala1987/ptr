 ...
 */
public class CustomerLogoutService extends HybrisService implements IService {
     ...
     */
    protected CustomerLogoutService(IRequest request, String endPoint) {
        super(request, endPoint);
    }

    @Override
    public IResponse getResponse() {
        Assert.assertNull("The message body was populated but the service reported a " + restResponse.getStatusCode() + " " + restResponse.getStatusLine().toString(), restResponse);
