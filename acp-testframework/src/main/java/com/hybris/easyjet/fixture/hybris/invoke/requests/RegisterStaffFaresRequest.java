...
public class RegisterStaffFaresRequest extends HybrisRequest implements IRequest {
     ...
     */
    public RegisterStaffFaresRequest(HybrisHeaders headers, IPathParameters pathParameters, IRequestBody requestBody) {
        super(headers, HttpMethods.POST, pathParameters,null, requestBody);
    }
}
